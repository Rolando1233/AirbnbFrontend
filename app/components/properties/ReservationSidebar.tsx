...
const ReservationSidebar: React.FC<ReservationSidebarProps> = ({
    ...
    const _setDateRange = (selection: any) => {
        ...
        const newEndtDate  = new Date(selection.endDate);

        if (newEndtDate <= newStartDate) {
            newEndtDate.setDate(newStartDate.getDate() + 1);
        }
    ...
    return (
        <aside className="mt-4 p-6 col-span-2 rounded-xl border border-gray-300">
